...
urlpatterns = [
    ...
    path("getUsers/<id>/", views.getUserbyId, name="getUserbyId"),  # geting user by id
    path(
    ...
    path("block-coord-users/<int:id>", views.BlockCordUsers, name="BlockCordUsers"),
    path(
    ...
    path("getCategories/<int:id>", views.getEventTypesbyId, name="getEventTypesbyId"),
    ...
    path("approveUserItems/<int:id>", views.approveUserItems, name="approveUserItems"),
    path(
    ...
    path("event-users-Booking/", views.events_user_Booking, name="events_user_Booking"),
    path(
    ...
    path("getEventorder-yearly/", views.get_yearly_revenue, name="get_yearly_revenue"),
    path("getEventorder-weekly/", views.get_weekly_revenue, name="get_weekly_revenue"),
    path(
    ...
    path(
        "clients-count/", views.clients_count, name="clients_count"
    ),
    path(
        "venders-count/", views.clients_count, name="clients_count"
    ),
    path(
        "coordinators-count/", views.coordinators_count, name="coordinators_count"
    ),
    path(
        "event-revenue/", views.event_revenue, name="event_revenue"
    ),
]
