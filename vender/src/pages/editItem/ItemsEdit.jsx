  ...
  const onSubmit = async (data) => {
    try {
      ...
      const datas = {
        ...
        seating_capacity: items.seating_capacity,
        fuel_type: items.fuel_type,
        transmission_type: items.transmission_type,
        flower_type: items.flower_type,
        color_scheme: items.color_scheme,
        arrangement_style: items.arrangement_style,
        size: items.size,
        additional_decor: items.additional_decor,
        mat_material: items.mat_material,
        mat_type: items.mat_type,
        color: items.color,
        pattern: items.pattern,
        platoon_size: items.platoon_size,
        platoon_type: items.platoon_type,
        platoon_uniform: items.platoon_uniform,
        performance_style: items.performance_style,
      };
      ...
      await axios.put(`/${itemURL}${item_type}/${id}`, datas, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
